  ...
  return (
    <>
      ...
      <div className="space-y-6" data-testid="cv-form">
        <h2 className="text-xl font-semibold text-gray-900">2. Informations personnelles</h2>
      ...
      {/* Experience Section */}
      <div className="space-y-6" data-testid="experiences-section">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">3. Expériences professionnelles</h2>
          <Button
            type="button"
            variant="outline"
            size="sm"
        ...
        {formData.experiences.map((experience, index) => (
          <div key={experience.id || index} className="p-6 border border-gray-200 rounded-lg space-y-4" data-testid={`experience-${index}`}>
            <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <label htmlFor={`experience-current-${index}`} className="text-sm text-gray-700">
                  Poste actuel
                </label>
              </div>
            </div>
      ...
      {/* Education Section */}
      <div className="space-y-6" data-testid="education-section">
        <div className="flex items-center justify-between">
        ...
        {formData.education.map((education, index) => (
          <div key={education.id || index} className="p-6 border border-gray-200 rounded-lg space-y-4" data-testid={`education-${index}`}>
            <div className="flex items-center justify-between">
      ...
      <div className="space-y-6" data-testid="skills-section">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold text-gray-900">5. Compétences</h2>
          <Button
            type="button"
            variant="outline"
            size="sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {formData.skills.map((skill, index) => (
            <div key={skill.id || index} className="p-4 border border-gray-200 rounded-lg space-y-3" data-testid={`skill-${index}`}>
              <div className="flex items-center justify-between">
      ...
      {/* Languages Section */}
      <div className="space-y-6" data-testid="languages-section">
        <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {(formData.languages || []).map((language, index) => (
            <div key={language.id || index} className="p-4 border border-gray-200 rounded-lg space-y-3" data-testid={`language-${index}`}>
              <div className="flex items-center justify-between">
